...
int ZEXPORT inflate64 OF((z_stream64p strm, int flush));
int ZEXPORT inflate64End OF((z_stream64p strm));
int ZEXPORT inflate64Init2 OF((z_stream64p strm, int  windowBits));
